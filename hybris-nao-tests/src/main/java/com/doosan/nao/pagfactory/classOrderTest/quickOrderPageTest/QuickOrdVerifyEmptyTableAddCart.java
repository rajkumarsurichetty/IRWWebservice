...
public class QuickOrdVerifyEmptyTableAddCart extends TestInitializer{
	...
	@Test(priority=1,dataProvider="QuickOrdVerifyEmptyTableAddCart")
	...
	@DataProvider(name="QuickOrdVerifyEmptyTableAddCart")
	public static Object[][] getDataForShipments() throws InterruptedException
	{
		//TestInitializer.isBrowserAlive="N";
		return InputReader.getInputReader().getDataFromXLS("QuickOrdVerifyEmptyTableAddCart");
	...
	{int i=0;
		...
		{
			isBrowserAlive="A";
		path=ReportGenerator.setLogAndCreateScreenshot("QuickOrdVerifyEmptyTableAddCart~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
		...
		{//http://localhost/Hybris/Screenshots/
			path=ReportGenerator.setLogAndCreateScreenshot("QuickOrdVerifyEmptyTableAddCart~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
