...
public class SelectOrgExistenceTwoDropDown extends TestInitializer {
	...
	@Test(priority=1,dataProvider="SelectOrgExistenceTwoDropDown")
	public void validateSelectOrgPageTwoDropDownTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments, String testUrlName,String testCaseNumber) throws InterruptedException
	...
	@DataProvider(name="SelectOrgExistenceTwoDropDown")
	public static Object[][] getDataForShipments() throws InterruptedException
	{
		//TestInitializer.isBrowserAlive="N";
		return InputReader.getInputReader().getDataFromXLS("SelectOrgExistenceTwoDropDown");
	...
	{int i=0;
		...
		{
			isBrowserAlive="A";
			path=ReportGenerator.setLogAndCreateScreenshot("SelectOrgExistenceTwoDropDown~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			//addResultForTestCase("4603", "1350059", 1,"Test Passed  "+i++ );+ className + "_" + testCaseName + "_" + testData + "_"+ status +
			addResultForTestCase(testRunId,testCaseNumberID, 1, "Select Organization elements SelectOrgExistenceTwoDropDown~ "+browserName+"__"+localTestData+"_"+Constants.PASSED+"\n"+"![](http://che-dt-idc1/Hybris/reports/Screenshots/"+path+")");
			isBrowserAlive="N";
			wd.quit();		
		} else 
		{//http://localhost/Hybris/Screenshots/
			path=ReportGenerator.setLogAndCreateScreenshot("SelectOrgExistenceTwoDropDown~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
			addResultForTestCase(testRunId,testCaseNumberID, 5, "Select Organization elements SelectOrgExistenceTwoDropDown Failed ~ "+browserName+"__"+localTestData+"_"+Constants.FAILED+"\n"+"![](http://che-dt-idc1/Hybris/reports/Screenshots//SelectOrgExistenceTwoDropDown~"+browserName+"__"+localTestData+"_"+Constants.FAILED+".jpg)");
