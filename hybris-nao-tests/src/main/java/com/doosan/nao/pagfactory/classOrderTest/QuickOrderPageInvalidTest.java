...
public class QuickOrderPageInvalidTest extends TestInitializer {
	...
	@Test(dataProvider="QuickOrderPageInvalidTest")
	public void validateQuickOrderPageInvalidTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments, String testUrlName) throws InterruptedException
	{
	...
	@DataProvider(name="QuickOrderPageInvalidTest")
	public static Object[][] getDataForShipments() throws InterruptedException
	{
		//TestInitializer.isBrowserAlive="N";
		return InputReader.getInputReader().getDataFromXLS("QuickOrderPageInvalidTest");
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		...
		{
			isBrowserAlive="A";
			ReportGenerator.setLogAndCreateScreenshot("QuickOrderPageInvalidTest~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			isBrowserAlive="N";
			wd.quit();		
		} else 
		{
			ReportGenerator.setLogAndCreateScreenshot("QuickOrderPageInvalidTest~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
