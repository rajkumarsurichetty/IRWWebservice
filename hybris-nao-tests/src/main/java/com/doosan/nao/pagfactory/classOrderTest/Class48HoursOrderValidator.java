...
public class Class48HoursOrderValidator extends TestInitializer {
	...
	public void validateClass48OrderTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments,String orderClass, String testUrlName) throws InterruptedException
	{
		...
		yourShoppingCartPage.selecOrderClass(wd,orderClass);
...
*/
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		...
		{
			isBrowserAlive="A";
			ReportGenerator.setLogAndCreateScreenshot("Class48HoursOrderValidator~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			
		} else 
		{
			ReportGenerator.setLogAndCreateScreenshot("Class48HoursOrderValidator~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
