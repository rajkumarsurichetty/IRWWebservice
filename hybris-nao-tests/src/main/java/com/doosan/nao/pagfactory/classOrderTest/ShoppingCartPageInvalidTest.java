...
public class ShoppingCartPageInvalidTest extends TestInitializer {
		...
		@Test(dataProvider="ShoppingCartPageInvalidTest")
		...
		@DataProvider(name="ShoppingCartPageInvalidTest")
		public static Object[][] getDataForShipments() throws InterruptedException
		{
			//TestInitializer.isBrowserAlive="N";
			return InputReader.getInputReader().getDataFromXLS("ShoppingCartPageInvalidTest");
		...
		public void onTestFailure(ITestResult result) throws IOException
		{
			...
			{
				isBrowserAlive="A";
				ReportGenerator.setLogAndCreateScreenshot("ShoppingCartPageInvalidTest~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
				isBrowserAlive="N";
				wd.quit();			
			} else 
			{
				ReportGenerator.setLogAndCreateScreenshot("ShoppingCartPageInvalidTest~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
