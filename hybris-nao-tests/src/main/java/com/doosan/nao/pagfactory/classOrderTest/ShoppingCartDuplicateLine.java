...
public class ShoppingCartDuplicateLine extends TestInitializer{
	...
	@Test(dataProvider="ShoppingCartDuplicateLine")
	...
	@DataProvider(name="ShoppingCartDuplicateLine")
	public static Object[][] getDataForShipments() throws InterruptedException
	{
		//TestInitializer.isBrowserAlive="N";
		return InputReader.getInputReader().getDataFromXLS("ShoppingCartDuplicateLine");
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		...
		{
			isBrowserAlive="A";
			ReportGenerator.setLogAndCreateScreenshot("ShoppingCartDuplicateLine~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			isBrowserAlive="N";
			wd.quit();			
		} else 
		{
			ReportGenerator.setLogAndCreateScreenshot("ShoppingCartDuplicateLine~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
