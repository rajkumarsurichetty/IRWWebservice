...
public class ClassTwoOrderValidator extends TestInitializer {
	...
	public void validateClassTwoOrderTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments, String testUrlName) throws InterruptedException
	{
		...
		yourShoppingCartPage.selecOrderClass(wd,"Class 2 - Breakdown - Non-Warranty");
		}
		//yourShoppingCartPage.selecOrderClass(wd,"Class 2 - Breakdown - Non-Warranty");
		...
		System.err.println("i am Out of if");
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		...
		{
			isBrowserAlive="A";
			ReportGenerator.setLogAndCreateScreenshot("ClassTwoOrderValidator~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			isBrowserAlive="N";
			wd.quit();		
		} else 
		{
			ReportGenerator.setLogAndCreateScreenshot("ClassTwoOrderValidator~"+browserName, Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
