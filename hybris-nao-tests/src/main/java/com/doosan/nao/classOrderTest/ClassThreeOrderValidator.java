...
//	String itemNo="91V1165";
	...
	public void ValidateClassThreeOrderValidatorTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments, String testUrlName) throws IOException, URISyntaxException, InterruptedException
	{
		localTestData=testData;
		//System.err.println("ClassOneOrderValidator1");
		ReportGenerator.setLog("ClassThreeOrderValidator is initated with input likes :"+ "  brand :>> "+brand+"   Customer No :>> "+custNo+"  item No :>> "+itemNo+"  Order Class :>> "+" Browser :>>"+currentBrowser+" Current Url :>>"+testUrlName);
		...
		validateThreeOrderValiatation(itemNo, qty, binLocation, comments);
		try {
...
if (brand.trim().equals("Doosan".trim()))
{
	...
	waitForTermsAndConditionsCheckBox.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[3]/label/input")));
	wd.findElement(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[3]/label/input")).click();
	ReportGenerator.setLog("ClassThreeOrderValidator is sucessfully completd with input likes :"+ "  brand :>> "+brand+"   Customer No :>> "+custNo+"  item No :>> "+itemNo+"  Order Class :>> "+" Browser :>>"+currentBrowser);
	
	wd.findElement(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[1]/button")).click();
	//TestInitializer.isBrowserAlive="A";
	ReportGenerator.setLogAndCreateScreenshot("ClassThreeOrderValidator", "ValidateClassThreeOrder", testData, "pass", wd);
	}
	}
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		if (result.isSuccess())
		{
			System.out.println("ClassThreeOrderValidator pass");
			ReportGenerator.setLogAndCreateScreenshot("ClassThreeOrderValidator", Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			
		} else 
		{
			

			System.out.println("ClassThreeOrderValidator Fail");
			ReportGenerator.setLogAndCreateScreenshot("ClassThreeOrderValidator", Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
	...
	public void validateThreeOrderValiatation(String itemNo, String qty, String binLocation, String comments)
	{
		...
		selectOrderClass.selectByIndex(4);
