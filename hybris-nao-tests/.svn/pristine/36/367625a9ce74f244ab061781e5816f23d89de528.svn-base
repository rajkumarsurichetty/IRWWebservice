...
//	String itemNo="91V1165";
	...
	@BeforeMethod
	public void setUpForClassOneOrderTest(String browser, String browserVersion, String platform, String osVersion) throws IOException, URISyntaxException, InterruptedException
	{	
		if(wd==null){
	...
	public void ValidateClassOneOrderTest(String testData,String userName,String password, String brand, String custNo, String itemNo, String qty, String binLocation, String comments,String testUrlName) throws IOException, URISyntaxException, InterruptedException
	{
		this.localTestData=testData;
		TestInitializer.failureClassName="ClassOneOrderValidator";
		TestInitializer.failureTestData=testData;
		
		System.err.println("ClassOneOrderValidator1"+ userName+"---"+password);
		ReportGenerator.setLog("ClassOneOrderValidator is initated with input likes :"+ "  brand :>> "+brand+"   Customer No :>> "+custNo+"  item No :>> "+itemNo+"  Order Class :>> "+" Browser :>>"+currentBrowser+" Current Url :>>"+testUrlName);
		...
		handlingUntrustuedSiteErrorForIE();
		validateQuickOderInClassOneOrder(itemNo, qty, binLocation,comments);
...
if (brand.trim().equals("Doosan".trim()))
{
	...
	waitForTermsAndConditionsCheckBox.until(ExpectedConditions.elementToBeClickable(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[3]/label/input")));
	wd.findElement(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[3]/label/input")).click();
	ReportGenerator.setLog("ClassOneOrderValidator is sucessfully completd with input likes :"+ "  brand :>> "+brand+"   Customer No :>> "+custNo+"  item No :>> "+itemNo+"  Order Class :>> "+" Browser :>>"+currentBrowser);
	
	wd.findElement(By.xpath("html/body/div[2]/div[2]/form/nav[1]/ul/li[1]/button")).click();
	//TestInitializer.isBrowserAlive="A";
	ReportGenerator.setLogAndCreateScreenshot("ClassOneOrderValidator", "ValidateClassOneOrder", testData, "pass", wd);
	}
	...
	public void onTestFailure(ITestResult result) throws IOException
	{
		if (result.isSuccess())
		{
			System.out.println("ClassOneOrderValidator pass");
			ReportGenerator.setLogAndCreateScreenshot("ClassOneOrderValidator", Constants.DEFAULT_TESTNAME, localTestData, Constants.PASSED, wd);
			
		} else 
		{
			

			System.out.println("ClassOneOrderValidator Fail");
			ReportGenerator.setLogAndCreateScreenshot("ClassOneOrderValidator", Constants.DEFAULT_TESTNAME, localTestData, Constants.FAILED,result.getThrowable().toString(),wd);
	...
	public void validateQuickOderInClassOneOrder(String itemNo, String qty, String binLocation, String comments)
	{
		wd.findElement(By.xpath("html/body/div[2]/div[1]/div/ul/li[4]/a")).click();
		handlingUntrustuedSiteErrorForIE();
